...
const VOICE = "zh-TW-YunJheNeural"; // 雲哲(男聲,轉播感)
const SCRIPTURE_VOICE = "zh-TW-HsiaoChenNeural"; // 曉臻(柔和女聲,讀經專用,07-13 鐵則)

let made = 0, skipped = 0, failed = 0;
const JOBS = [...PHRASES.map((t) => [t, VOICE]), ...(SCRIPTURES || []).map((t) => [t, SCRIPTURE_VOICE])];
for (const [text, voiceName] of JOBS) {
